...
**Дата:** 2026-07-22
**Статус:** ПОГЛОЩЁН `2026-07-22-collector-module-restructure-design.md` —
механизм развязки (`RESPONSE_HOOKS`, `http/tls.py`, движко-независимый
`build_http_client`) вошёл туда как §5. Реализуется в рамках реструктуризации,
отдельно этот заход не исполняется.
